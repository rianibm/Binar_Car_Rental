class Car {
  ...
  render() {
    ...
    return `
    <div class="col">
    <div class="d-flex card shadow bg-white" style="width: 333px; 
    border-radius: 8px;
    ...
    font-style: normal;
    font-weight: 300;">
      <img src="${image}" class="card-img-top img-fluid" style="width: 300px; height: 200px; object-fit: cover;" />
      <div>
        <p style="font-weight:300;">${manufacture} ${model}</p>
